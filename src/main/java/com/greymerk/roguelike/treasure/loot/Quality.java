...
public enum Quality{
	...
	static {
		...
		armourQuality.put(Difficulty.EASIEST, 	create(300, 80, 40, 20, 5, 2));
		armourQuality.put(Difficulty.EASY, 		create(200, 60, 40, 20, 5, 2));
		armourQuality.put(Difficulty.MEDIUM, 	create(50, 60, 40, 20, 5, 3));
		armourQuality.put(Difficulty.HARD, 		create(5, 20, 40, 60, 5, 5));
		armourQuality.put(Difficulty.HARDEST, 	create(1, 5, 10, 50, 5, 10));
		
		weaponQuality.put(Difficulty.EASIEST, 	create(100, 200, 100, 50, 2, 1));
		weaponQuality.put(Difficulty.EASY, 		create(50, 100, 100, 50, 5, 2));
		weaponQuality.put(Difficulty.MEDIUM, 	create(10, 40, 40, 80, 5, 5));
		weaponQuality.put(Difficulty.HARD, 		create(5, 10, 10, 70, 5, 5));
		weaponQuality.put(Difficulty.HARDEST, 	create(1, 5, 5, 50, 5, 10));
		
	}

	private static WeightedRandomizer<Quality> create(int wood, int stone, int copper, int iron, int gold, int diamond){
